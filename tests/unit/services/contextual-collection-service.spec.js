...
const ContextualCollectionService = require('../../../services/contextual-collection-service.js');
const { createMockLogger } = require('../../__mocks__/winston');

describe('ContextualCollectionService', () => {
  let service;
  let mockLogger;

  beforeEach(() => {
    mockLogger = createMockLogger();
    service = new ContextualCollectionService(mockLogger);
  });
