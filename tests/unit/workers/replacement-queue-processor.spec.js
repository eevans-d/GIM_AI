...
const ReplacementQueueProcessor = require('../../../workers/replacement-queue-processor.js');
const { createMockLogger } = require('../../__mocks__/winston');

describe('ReplacementQueueProcessor', () => {
  let worker;
  let mockLogger;

  beforeEach(() => {
    mockLogger = createMockLogger();
    worker = new ReplacementQueueProcessor(mockLogger);
  });
